...
const socials = [
    {
        name: 'Instagram',
        href: 'https://instagram.com/atanga.joseph',
    ...
    {
        name: 'GitHub',
        href: 'https://github.com/atangajoseph',
        ...
        <div className="min-h-screen">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <div>
                            ...
                            <p className="text-foreground/80">Feel free to reach out if you&apos;re looking for a developer, have a question, or just want to connect.</p>
                        </div>
            ...
            <section className="py-16 bg-accent/30">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    <p className="text-foreground/80 mb-4">Prefer a direct email?</p>
                    <a
                        href="mailto:josephatanga25@gmail.com"
